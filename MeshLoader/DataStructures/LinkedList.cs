        ...
        public class LinkedList : IEnumerable, ICollection
        {
            ...
            class ListEnumerator : IEnumerator
            {
                ...
                public object Current
                {
                    ...
                    {
                        if (beforefirst)
                            throw new InvalidOperationException("The Iterator position is before the first element");
                        if (node == null)
                            throw new InvalidOperationException("The Iterator position is after the last element");
                        return node.Data;
                    }
                }
